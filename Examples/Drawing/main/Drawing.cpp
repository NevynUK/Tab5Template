/*-----------------------------------------------------------------------------
 * File        : Drawing.cpp
 * Description : Drawing example application for the M5Stack Tab5 firmware.
 *               Initialises all on-board hardware (display, touch, SD card,
 *               RTC, IMU, power monitor, charge manager, RS-485 and camera),
 *               renders a status splash, then enters the drawing demonstration.
 * Author      : Mark Stevens
...
void Setup(void)
{
    ...
    display.drawString("Drawing Example", centreX, lineY);
    lineY += lineHeight;
