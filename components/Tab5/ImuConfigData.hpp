/*-----------------------------------------------------------------------------
 * File        : ImuConfigData.hpp
 * Description : BMI270 internal configuration file data.  This binary blob
 *               must be written to the BMI270 INIT_DATA register during
 *               sensor initialisation before the accelerometer and gyroscope
 *               can be used.
 * Author      : Mark Stevens
...
/*
 * BMI270 configuration file — © 2023 Bosch Sensortec GmbH, BSD-3-Clause.
...
/**
 * @brief Number of bytes in the BMI270 configuration blob.
 */
static constexpr size_t BMI270_CONFIG_SIZE = sizeof(bmi270_config_file);
